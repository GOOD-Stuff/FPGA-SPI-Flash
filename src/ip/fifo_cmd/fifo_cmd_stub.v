...
/* synthesis syn_black_box black_box_pad_pin="rst,wr_clk,rd_clk,din[59:0],wr_en,rd_en,dout[59:0],full,empty,wr_data_count[9:0],prog_full,prog_empty,wr_rst_busy,rd_rst_busy" */;
  input rst;
  input wr_clk;
  input rd_clk;
  input [59:0]din;
