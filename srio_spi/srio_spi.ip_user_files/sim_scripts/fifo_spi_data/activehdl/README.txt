...
#
# Generated by export_simulation on Wed Jan 17 18:39:14 +0300 2018
#
################################################################################
...
switch to the './fifo_spi_data.sh' script.

./fifo_spi_data.sh -reset_run
...
./fifo_spi_data.sh -noclean_files

For more information on the script, please type './fifo_spi_data.sh -help'.
